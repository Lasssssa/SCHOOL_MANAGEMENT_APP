...
<html lang="fr">
    <head>
        ...
        <title>Page Enseignant : Consultation</title>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">ÉTUDIANTS AU RATTRAPAGE</h5>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" id="titre">
                                        ...
                                        foreach($epreuves as $epreuve){
                                            ...
                                            if($note != null){
                                                ...
                                                echo '<h4>'.$epreuve['nom_epreuve'].'</h4>';
                                                echo '<input type="number" class="form-control" placeholder="Non noté" disabled><br>';
                                            }
                                        }
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary colored" name="modifier">Enregistrer</button>
                                        <button type="button" class="btn btn-secondary coloredV4" data-bs-dismiss="modal">Fermer</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                    ...
                    if($coursesOfAProfessor == null){
                        ...
                        foreach($coursesOfAProfessor as $course){
                                ...
                                echo '<h2 class="accordion-header">
                                    ...
                                    clinical_notes
                                    </span>&nbsp&nbsp&nbsp'.$course['nom_matiere'].'
                                    </h1>
                                    </button>
                                    </h2>';
                                ...
                                if($studentOfCourse != null){
                                    ...
                                    echo '</table>';
                                    echo '<br>';
                                    echo '<button type="submit" class="btn btn-danger coloredV4" data-bs-toggle="modal" data-bs-target="#rattrapage_'.$course['id_matiere'].'" name="supp_'.$cours['id_matiere'].'">Rattrapages
                                    </button>';
                                    echo '</div>';
                                    echo '</div>';
                                    echo '</div>';
