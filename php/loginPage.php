    ...
    <body>
        ...
        <div id="bodyLogin">
            ...
            <div id="centerLogin">
                ...
                <!-- <div id="chooseRole">
                    <div id="enseignant">
                        <button type="button" class="butt"><a href="loginEnseignant.php">Enseignant</a></button>
                    </div>
                    <div id="admin">
                        <button type="button" class="butt"><a href="loginAdmin.php" >Administrateur</a></button>
                    </div>
                    <div id="etudiant">
                        <button type="button" class="butt"><a href="loginEtudiant.php" >Étudiant</a></button> 
                    </div>               
                </div> -->
            </div>
            <div id="rightLogin">
