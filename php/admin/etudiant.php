...
<html lang="fr">
    <head>
        ...
        <title>Page Administrateur : Étudiant</title>
    ...
    <body>
        ...
        <?php 
            ...
            if(isset($_POST['modifier'])){
                ...
                $true = updateStudent($dbConnection, $_POST['nom'], $_POST['prenom'], $_POST['mail'], $_POST['id_etu'], $id_classe, $_POST['telephone']);
                if($true){
                    echo '<div class="alert alert-success" role="alert">
                    ...
                    echo '<div class="alert alert-danger" role="alert">
                    L\'étudiant n\'a pas été modifié.
                    </div>';
                }
            }
